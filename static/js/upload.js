document.addEventListener('DOMContentLoaded', function () {
    ...
    fileInput.addEventListener('change', function () {
        ...
        for (const file of fileInput.files) {
            ...
            uploadSingleFile(file, previewElement);
            addedPDF = true;
        }
    ...
    deleteBtn.addEventListener('click', () => {
        ...
        // if no files remain, show empty state again
    ...
    function updateStatus(previewElement, status) {
        ...
        let config = {
            success: {
                ...
                text: 'Processed',
                icon: `
                    <svg class="status-icon w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
    ...
    function uploadSingleFile(file, previewElement) {
